...
function Navbar_admin() {
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu menu-sm dropdown-content bg-black mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 text-white">
        <li><a href='/profile'>Profile</a></li>
        <li><a href='/home'>Home</a></li>
        <li><a href='/sub'>Submissions</a></li>
        <li><a href='/createproblem'>Add Problem</a></li>
        <li><a href='/logout'>Logout</a></li>
      </ul>
    </div>
  </div>
  <div className="navbar-center">
    <a className=" text-2xl font-bold text-white">Code_wars</a>
  </div>
